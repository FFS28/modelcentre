...
abstract class AbstractType
{
    ...
    public function getPriceHtml()
    {
        if ($this->haveSpecialPrice()) {
            ...
            . '<div class="price-from"><span class="special-price">' . core()->currency($this->evaluatePrice($this->getSpecialPrice())) . '</span><br><span class="regular-price" style="color: lightgrey; font-size: 16px"><label>Regular Price&nbsp</label>' . core()->currency($this->evaluatePrice($this->product->price)) . '</span>';
            if($this->haveSufficientQuantity(1))
                $html .= '<div class = "have-Qty">In Stock</div>';
            else
                $html .= '<div class = "have-Qty">Out Of Stock</div>';
        } else {


            $html = '<span class="price-from">' . core()->currency($this->evaluatePrice($this->product->price));
            if($this->haveSufficientQuantity(1))
                $html .= '<div class = "have-Qty">In Stock</div>';
            else
                $html .= '<div class = "have-Qty">Out Of Stock</div>';
