                ...
                <div class="wrapper" v-if="this.rootCategories">
                    ...
                    >
                        ...
                        >
                            <a
                                class="unset"
                                :href="`${$root.baseUrl}/${category.url_path}`"
                            >
                ...
                <div class="wrapper" v-else-if="subCategory">
                    ...
                    <ul type="none">
                        ...
                        >
                            <a
                                class="unset"
                                :href="`${$root.baseUrl}/${nestedSubCategory.url_path}`"
                            >
                                <div class="category-logo">
                                    <img
                                        class="category-icon"
                            ...
                            >
                                ...
                                >
                                    <a
                                        class="unset"
                                        :href="`${$root.baseUrl}/${thirdLevelCategory.url_path}`"
                                    >
                                        <div class="category-logo">
                                            <img
                                                class="category-icon"
...
export default {
    ...
    mounted: function() {
        console.log(this.rootCategoriesCollection)
    },
