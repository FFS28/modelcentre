...
Vue.component('category-card', () => import('@components/category-card'));
...
Vue.component('category-slider', () => import('@components/category-slider'));
...
Vue.component('add-infos', () => import('@components/add-infos'));
