...
<div class="pmy-carousel mb-5">
    <div class="col-lg-12 col-md-12 col-sm-4 col-xs-4">
        <img src="{{ asset('/themes/velocity/assets/images/intro1.png') }}" width="100" style=" width: 100%;" />
    </div>
    <div class="col-lg-12 col-md-12 col-sm-4 col-xs-4">
        <img src="{{ asset('/themes/velocity/assets/images/intro2.png') }}" width="100" style=" width: 100%;" />
    </div>
    <div class="col-lg-12 col-md-12 col-sm-4 col-xs-4">
        <img src="{{ asset('/themes/velocity/assets/images/intro3.png') }}" width="100" style=" width: 100%;" />
    </div>
    <div class="col-lg-12 col-md-12 col-sm-4 col-xs-4">
        <img src="{{ asset('/themes/velocity/assets/images/intro4.png') }}" width="100" style=" width: 100%;" />
    </div>
</div>