<header class="sticky-header">
    <div class="row remove-padding-margin velocity-divide-page" style="text-align: center;">
        <a class="left navbar-brand" href="{{ route('shop.home.index') }}" aria-label="Logo" style="padding-right:10px">
