        ...
        Vue.component('category-component', {
            ...
            methods: {
                'getCategoryProducts': function () {
                    this.$http.get(`${this.$root.baseUrl}/api/descendant-categories?parent_id={{ $category->id }}`).then(response => {
                        categories = response.data.data.map(item => item.id)
                        categories.push({{ $category->id }})
                        this.$http.get(`${this.$root.baseUrl}/category-products/${categories.join(',')}${window.location.search}`)
                        .then(response => {
