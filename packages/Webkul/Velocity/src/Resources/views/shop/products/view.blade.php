                        ...
                        <div class="form-container">
                            ...
                            <div class="row" style="margin: 0px; !important">
                                ...
                                <div class="right col-lg-5 col-md-6">
                                    ...
                                    <div class="info">
                                        <h2 class="col-12 font-weight-bold">{{ $product->name }}</h2>
                                        ...
                                        <div class="row mt-2" style="align-items: center">
                                            <div class="col-6 price" style="font-size: 28px">
                                                @include ('shop::products.price', ['product' => $product, 'type' => "detail"])

                                                @if (Webkul\Tax\Helpers\Tax::isTaxInclusive() && $product->getTypeInstance()->getTaxCategory())
                                                    <span style="color: #0580B8;">
                                        ...
                                        <div class="col-12">
                                            <add-infos product="{{ $product->product_id }}" token="{{ csrf_token() }}"></add-infos>
                                        </div>
                                    ...
                                    <div class="row mt-2 mb-2" style="align-items: center;">
                                        ...
                                        <div class="col-6 price" style="text-align: right; font-size: 28px">
                                            @include ('shop::products.price', ['product' => $product, 'type' => "detail"])
...
@push('scripts')
    ...
    <script type="text/javascript" src="{{ asset('themes/velocity/assets/js/tikslus360.js') }}"></script>
