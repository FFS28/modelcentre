...
@php
    ...
    $image360 = productimage()->get360Images($product);
    ...
    if(count($image360) > 0) {
        array_unshift($images, [
            "small_image_url" => env('APP_URL')."/themes/velocity/assets/images/360icon.jpg",
            "medium_image_url" => "http://127.0.0.1:8000/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.webp",
            "large_image_url" => $image360,
            "original_image_url" => "http://127.0.0.1:8000/vendor/webkul/ui/assets/images/product/meduim-product-placeholder.webp",
            "type" => "image360"
        ]);
    }
    ...
    foreach ($images as $key => $image) {
        ...
        $imageData[$key]['type'] = '';
        if(isset($image['type']))
            $imageData[$key]['type'] = "image360";
        $imageData[$key]['large_image_url']    = json_encode($image['large_image_url']);
